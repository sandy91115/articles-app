<article class="reader-article-card">
    <a class="reader-card-link" href="{{ $article['reader_url'] }}">
        @if ($article['image_url'])
            <img class="reader-card-image" src="{{ $article['image_url'] }}" alt="{{ $article['title'] }}">
        @else
    ...
    <div class="reader-card-body">
        ...
        <div class="reader-rating-row">
            <strong>{{ number_format($article['rating_average'], 1) }}</strong>
        ...
        <div class="reader-card-footer">
            ...
            <div class="reader-inline-actions">
                <a class="reader-inline-link" href="{{ $article['reader_url'] }}">Read more</a>
                <button
